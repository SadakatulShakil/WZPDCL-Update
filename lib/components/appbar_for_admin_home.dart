...
*/
    ...
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => CustomerGuideLine()));
...
class AppBarAdminHome extends AppBar {
  AppBarAdminHome(
              ...
              PopupMenuButton<PopUpNavMenu>(
                  ...
                  itemBuilder: (context) {
                    return [
                      ...
                      /*PopupMenuItem(
                        child: menuItem(Languages.of(context)!.ManageAccount, 'manage.svg'),
                        value: PopUpNavMenu.ManageAccount,
                      ),*/
                      PopupMenuItem(
                        child: menuItem(
                            Languages.of(context)!.LogOut, 'logout.svg'),
...
Widget menuItem(String text, String assetName) {
  ...
  return Container(
      ...
      width: 900,
      child: Row(children: [
        SvgPicture.asset('assets/vectors/nav_menu/$assetName'),
        SizedBox(
          width: 24.08,
        ),
        Text(text),
